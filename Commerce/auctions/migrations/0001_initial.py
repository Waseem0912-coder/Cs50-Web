# Generated by Django 3.1.7 on 2021-03-06 08:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bid_categories', models.ManyToManyField(to='auctions.Category')),
                ('bid_comments', models.ManyToManyField(to='auctions.Comments')),
                ('current_bidder', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auctions.bidder')),
            ],
        ),
        migrations.CreateModel(
            name='Watchlist',
